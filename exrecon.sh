    ...
    if command -v batcat >/dev/null 2>&1; then
        batcat "$1"
              ...
              bat "$1"
                    ...
                    less "$1"
                      elif command -v xdg-open >/dev/null 2>&0; then
                          xdg-open "$1"
                            else
                                cat "$1"
                                  fi
      ...
      case "$scan_type" in
          1)
                echo -e "${CYAN}[*]${NC} Running Quick Scan..."
                      proxychains4 nmap -sT -Pn -n --top-ports 100 -T2 --reason --data-length 50                               $decoy_flag -f --host-timeout 5m                                       --dns-servers 8.8.8.8 -oN "$output_file.quick" "$target"
                                            ;;
                                                2)
                                                      echo -e "${CYAN}[*]${NC} Running Service Detection..."
                                                            proxychains4 nmap -sT -Pn -sV -T2                                                                     --script=banner,http-title,http-enum,ssl-cert                                                                             --script-args "http.useragent=$ua_string"                                                                                     --data-length 100 $decoy_flag -f --host-timeout 5m                                                                                             --dns-servers 8.8.8.8 -oN "$output_file.service" "$target"
                                                                                                  ;;
                                                                                                      3)
                                                                                                                  ...
                                                                                                                  read -rp "Continue anyway? (y/n): " udp_confirm
                                                                                                                        [[ "$udp_confirm" != "y" ]] ; continue
                                                                                                                              echo -e "${CYAN}[*]${NC} Running UDP Vuln Scan..."
                                                                                                                                    proxychains4 nmap -sU -sV -Pn --script vuln                                                                                                                                             --data-length 120 $decoy_flag -f --host-timeout 5m                                                                                                                                                     -T2 -oN "$output_file.udp" "$target"
                                                                                                                                                          ;;
                                                                                                                                                              4)
                                                                                                                                                                    echo -e "${CYAN}[*]${NC} Running Full Port Scan..."
                                                                                                                                                                          proxychains4 nmap -sT -Pn -p- -T2 --reason --data-length 40                                                                                                                                                                                   $decoy_flag -f --host-timeout 10m                                                                                                                                                                                           --dns-servers 8.8.8.8 -oN "$output_file.full" "$target"
                                                                                                                                                                                                ;;
                                                                                                                                                                                                    5)
                                                                                                                                                                                                          echo -e "${CYAN}[*]${NC} Running Aggressive Scan..."
                                                                                                                                                                                                                proxychains4 nmap -A -T3 -Pn --reason --data-length 60                                                                                                                                                                                                                         $decoy_flag -f --host-timeout 5m                                                                                                                                                                                                                                 --dns-servers 8.8.8.8 -oN "$output_file.aggressive" "$target"
                                                                                                                                                                                                                                      ;;
                                                                                                                                                                                                                                          6)
                                                                                                                                                                                                                                                echo -e "${CYAN}[*]${NC} Running Firewall Evasion Scan..."
                                                                                                                                                                                                                                                      proxychains4 nmap -sT -Pn -T2 --ttl 65 --reason --data-length 80                                                                                                                                                                                                                                                               $decoy_flag -f --host-timeout 5m                                                                                                                                                                                                                                                                       --dns-servers 1.1.1.1 -oN "$output_file.evasion" "$target"
                                                                                                                                                                                                                                                                            ;;
                                                                                                                                                                                                                                                                                7)
                                                                                                                                                                                                                                                                                      echo -e "${CYAN}[*]${NC} Running Web App Enumeration..."
                                                                                                                                                                                                                                                                                            proxychains4 nmap -sV -p 80,443,8080 -Pn                                                                                                                                                                                                                                                                                                     --script http-title,http-enum                                                                                                                                                                                                                                                                                                             --script-args "http.useragent=$ua_string"                                                                                                                                                                                                                                                                                                                     --data-length 100 $decoy_flag --host-timeout 5m                                                                                                                                                                                                                                                                                                                             -oN "$output_file.webnmap" "$target"
                                                                                                                                                                                                                                                                                                                                  if check_nikto; then
                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                      read -rp "Continue anyway? (y/n): " syn_confirm
                                                                                                                                                                                                                                                                                                                                                                            [[ "$syn_confirm" != "y" ]] ; continue
                                                                                                                                                                                                                                                                                                                                                                                  echo -e "${CYAN}[*]${NC} Running Stealth SYN Scan..."
                                                                                                                                                                                                                                                                                                                                                                                        proxychains4 nmap -sS -Pn -T1 -n --top-ports 100 --reason --data-length 60                                                                                                                                                                                                                                                                                                                                                                                                 $decoy_flag -f --host-timeout 5m                                                                                                                                                                                                                                                                                                                                                                                                         --dns-servers 8.8.8.8 -oN "$output_file.stealth" "$target"
                                                                                                                                                                                                                                                                                                                                                                                                              ;;
                                                                                                                                                                                                                                                                                                                                                                                                                  *)
